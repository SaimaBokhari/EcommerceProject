...
public class TC_03_InvalidCredentials {
    /*
When
...
Then
   Verify the message "Password strength should be at least "Good".
    ...
    @Test
    public void TC_03_InvalidCredentials(){
        ...
        //   User enters valid password which contains uppercase, lowercase, digit and special char.
        vendorPage.passwordInput.sendKeys(ConfigReader.getProperty("vendor_invalidpassword"));

        //   User enters password in confirm password input.
        vendorPage.confirmPasswordInput.sendKeys(ConfigReader.getProperty("vendor_invalidpassword"));

        //   User clicks on the Register button.
        vendorPage.registerButton.click();

        //   Verify the message "Password strength should be at least "Good".
        assertTrue(vendorPage.passwordTooShortFailureMessage.isDisplayed());
